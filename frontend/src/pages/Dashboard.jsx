...
import Navbar from '../components/molecules/Navbar'; // Assuming Navbar is imported here for the layout
...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-bg-primary font-sans pb-20">
      
      {/* The Global Floating Navbar will sit on top */}
      <Navbar />
