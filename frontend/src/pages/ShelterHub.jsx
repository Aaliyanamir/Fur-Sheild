...
import { Search, Filter, Plus, MoreHorizontal, Clock, Heart, AlertCircle, LayoutGrid, List } from 'lucide-react';
...
export default function ShelterHub() {
  ...
  return (
    <div className="flex-1 flex flex-col w-full font-sans">
      ...
      {/* Portal Header */}
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-4 shrink-0 pt-4">
        <div>
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="flex items-center gap-2 bg-camel-600 hover:bg-camel-500 text-white px-5 py-2 rounded-full font-bold text-sm transition-all shadow-[0_5px_15px_rgba(186,127,72,0.3)]">
      ...
      <div className="flex-1 overflow-x-auto pb-4 scrollbar-hide">
        <div className="flex gap-6 h-full min-w-max">
          ...
          {columns.map((column) => {
            ...
            return (
              <div key={column.id} className="w-[320px] flex flex-col h-[calc(100vh-14rem)]">
                {/* Column Header */}
